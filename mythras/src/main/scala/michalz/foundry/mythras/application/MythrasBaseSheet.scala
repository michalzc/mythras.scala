...
import foundry.client.{ActorSheet, ActorSheetOptions}
...
class MythrasBaseSheet[AD <: MythrasActorData](actor: MythrasActor[AD], options: js.Dictionary[js.Any] = js.Dictionary.empty) extends ActorSheet(actor, options) {
