...
@js.native
@JSGlobal
class ActorSheet[SystemData <: js.Object, A <: Actor[SystemData]](actor: A, options: ApplicationOptions) extends DocumentSheet[SystemData, A, ActorSheetData[SystemData, A]] {
